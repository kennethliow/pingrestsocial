                ...
                <li class="active">
                    ...
                    <li class="">
                        ...
                        <a href="albums.jsp" id="albums-tab">Albums 
                            ...
                            if (albumController.getTaggedAlbumsList(user).size() != 0) {%> 
                            <span class="badge pull-right"><%=albumController.getTaggedAlbumsList(user).size()%> tagged album</span>
                            <%}%>
                        </a>
                    </li>
                </ul>
            ...
            <div class="section_holder">
                ...
                <div id="user_menu">
                    <div id="current_user_avatar"><img class="member_image img-rounded" src=<%=user.getProfilePicture()%>>
                        <a id="current_user" class="overflow-ellipsis" href="index.jsp">@<%=user.getUsername()%></a>
