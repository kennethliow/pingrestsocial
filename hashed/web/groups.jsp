            ...
            <div class="modal-header">
                ...
                <form id="editGroupForm" class="form-horizontal" action="UpdateGroupServlet">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info" onclick="editGroup();">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    function editGroup() {
        var last_name = $('#editGroupMembers').children(".type-zone").val();
        foo.jQuery('#editGroupMembers').tagging("add", last_name);
        $('#editGroupMembers').children(".type-zone").val("");
