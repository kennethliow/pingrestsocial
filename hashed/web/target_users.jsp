...
//            }
            ...
            function runData(response) {
                FB.api(
                    "/fql?q={" + encodeURIComponent("select uid,name from user where uid in ( select uid from page_fan where uid in (select uid2 from friend where uid1 = me()) and page_id = '258437627628348'") + "}",
                    function(data) {
                        console.log(data);
